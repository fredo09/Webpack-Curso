/** 
 *  Configuracion de Webpack Dev Server
 */
...
//Se exporta el modulo
 module.exports={
     ...
     devServer:{ //Agregando el puerto para correr la app
        port: 9000 
     },
     module:{
         rules:[
 ...
 *    },
 *    devServer:{
 *      port: 9000, //Con webpack-dev-server podemos decidir que puerte queremos correr la app
 *    },
 *      module:{
 *        rules:[
 *           {
